...
class UserPaymentMessages:
    ...
    def get_choose_withdraw_method() -> str:
        return (
            '<b>Ознакомьтесь с правилами вывода средств:</b> \n\n'
            '• Бонусные деньги не подлежат выводу без депозита \n\n'
            '• Дабы избежать злоупотребления реферальной системы и '
            'полученных сумм с промокодов — перед выводом у вас должен быть отыгрыш в размере депозита '
            '[пополнили <b>1000₽</b>,выиграли <b>500₽</b>, выиграли ещë <b>500₽</b> — ваш <b>отыгрыш</b> засчитан] \n\n'
            '💎 Выберите <b>способ вывода</b> средств с баланса:'
        )
    ...
    def enter_user_withdraw_requisites(withdraw_method: WithdrawMethod) -> str:
        ...
        elif withdraw_method == WithdrawMethod.CRYPTO_BOT:
            necessary_requisites = f"💳 Введите номер <b>криптокошелька</b> и <b>сеть</b>:"
